      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex space-x-4">
            <a href="https://x.com/" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center group hover:bg-blue-600 transition-all duration-300">
            ...
            <a href="https://www.linkedin.com/in/" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center group hover:bg-blue-600 transition-all duration-300">
              <svg className="w-5 h-5 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452z"></path>
              </svg>
            </a>
            <a href="https://github.com/" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center group hover:bg-blue-600 transition-all duration-300">
              <svg className="w-5 h-5 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="https://instagram.com/" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center group hover:bg-blue-600 transition-all duration-300">
              <svg className="w-5 h-5 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
